...
public class BeanUtils extends org.springframework.beans.BeanUtils {
	...
	public static void copyAllPropertiesExceptNull(Object source, Object target, String[] ignoreProperties) throws BeansException {
		copyAllPropertiesExceptNull(source, target, null, ignoreProperties);
	}

	public static void copyAllPropertiesExceptNull(Object source, Object target, Class<?> editable) throws BeansException {
		copyAllPropertiesExceptNull(source, target, editable, null);
	}

	public static void copyAllPropertiesExceptNull(Object source, Object target) throws BeansException {
		copyAllPropertiesExceptNull(source, target, null, null);
	}
	 ...
	 */
	private static void copyAllPropertiesExceptNull(Object source, Object target, Class<?> editable, String[] ignoreProperties) throws BeansException {
			...
			if (targetPd.getWriteMethod() != null && (ignoreProperties == null || (!ignoreList.contains(targetPd.getName())))) {
				...
				if (sourcePd != null && sourcePd.getReadMethod() != null) {
					try {
						...
						Object value = readMethod.invoke(source);
						if (value != null) {// 这里判断以下value是否为空，当然这里也能进行一些特殊要求的处理 例如绑定时格式转换等等
							boolean isEmpty = false;
							if (value instanceof Set) {
								Set s = (Set) value;
								if (s == null || s.isEmpty()) {
