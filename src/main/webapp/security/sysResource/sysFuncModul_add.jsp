...
<body>
	<form  action="sysResource/dnns_addFuncModul.do" name="menuModulForm" id="menuModulForm" method="post" >
		<input type="hidden" name="resourceType" id="resourceType" value="2"/>
		<input type="hidden" name="flag" id="flag" value="1"/>
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="resourceName" id="resourceName" placeholder="这里输入模块名称" value="" title="模块名称"/></td>
			</tr>
			<tr>
				<td><input type="text" name="resourceDescription" id="resourceDescription" placeholder="这里输入模块描述" value="" title="模块描述"/></td>
			</tr>
			<tr>
