...
<body>
	<form  action="sysResource/dnns_addFunc.do" name="funcForm" id="funcForm" method="post" >
		<span>模块名称：${modul.resourceName }</span>
		<input type="hidden" name="resourceParentid" id="resourceParentid" value="${modul.resourceId }"/>
		<input type="hidden" name="resourceType" id="resourceType" value="3"/>
		<input type="hidden" name="flag" id="flag" value="1"/>
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="resourceName" id="resourceName" placeholder="这里输入功能点名称" value="" title="功能点名称"/></td>
			</tr>
			<tr>
				<td><input type="text" name="resourceDescription" id="resourceDescription" placeholder="这里输入功能点描述" value="" title="功能点描述"/></td>
			</tr>
			<tr>
