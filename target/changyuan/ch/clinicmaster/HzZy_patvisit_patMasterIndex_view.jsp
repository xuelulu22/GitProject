...
<body>
	<form  action="sysUser/doAddUser.do" name="menuForm" id="menuForm" method="post" >
		...
		患者病例信息：
		<table border="1"style="border-color: lightblue;width: 100%;">
		<tr style="height: 30px"><td style="width: 150px" align="center">患者编号</td><td>${patVisit.patient_id }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">住院次数</td><td>${patVisit.visit_id }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">入院科室</td><td>${patVisit.dept_admission_to }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">入院日期</td><td>${patVisit.admission_date_time }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">出院科室</td><td>${patVisit.dept_discharge_from }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">出院日期</td><td>${patVisit.discharge_date_time }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">婚姻</td><td>${patVisit.marital_status }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">体重</td><td>${patVisit.body_weight }</td></tr>
		<tr style="height: 30px"><td style="width: 150px" align="center">身高</td><td>${patVisit.body_height }</td></tr>
		</table>
		</div>
		</div>
