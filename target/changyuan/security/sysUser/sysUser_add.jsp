...
<body>
	<form  action="sysUser/doAddUser.do" name="menuForm" id="menuForm" method="post" >
		...
		<table>
			<tr>
				<td><input type="text" name="userAccount" id="userAccount" placeholder="这里输入登录账号" value="" title="登录账号"/></td>
			</tr>
			<tr>
				<td><input type="text" name="userName" id="userName" placeholder="这里输入用户名" value="" title="用户名"/></td>
			</tr>
			<tr>
