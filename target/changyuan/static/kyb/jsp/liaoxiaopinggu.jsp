											...
											<table class="table table-bordered" data-fieldcode="F000001"
												...
												<thead style="font-family: &amp; #39;">
													<tr style="font-family: &amp; #39;">
														...
														<td
															style="text-align: center; width: 40px; font-family: &amp; #39;">是否基线</td>
														<td
															style="text-align: center; width: 40px; font-family: &amp; #39;">评估日期</td>
															<td
															style="text-align: center; width: 40px; font-family: &amp; #39;">靶病灶评估结果</td>
															<td
															style="text-align: center; width: 40px; font-family: &amp; #39;">非靶病灶评估结果</td>
															<td
															style="text-align: center; width: 40px; font-family: &amp; #39;">总体疗效评估</td>
														...
														<td colspan="10"
															style="text-align: right; font-family: &amp; #39;"><div
																...
																<a class="btn btn-mini btn-default showAddWindow"
																	href="javascript:window.open('static/kyb/jsp/liaoxiaopinggu2.jsp')" style="font-family: &amp; #39;">添加</a>
															</div></td>
													</tr>
												</tbody>
											</table>
